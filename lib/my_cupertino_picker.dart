...
class MyCupertinoPicker extends StatefulWidget {
  ...
  final BorderSide highlighterBorder;
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            decoration: BoxDecoration(
              border: Border(
                top: widget.highlighterBorder != null
                    ? widget.highlighterBorder
                    : BorderSide(width: 0.0, color: _kHighlighterBorder),
                bottom: widget.highlighterBorder != null
                    ? widget.highlighterBorder
                    : BorderSide(width: 0.0, color: _kHighlighterBorder),
              ),
            ),
